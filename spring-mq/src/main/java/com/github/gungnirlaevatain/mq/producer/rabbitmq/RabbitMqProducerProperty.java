...
@ConfigurationProperties(prefix = RabbitMqProducerProperty.PREFIX)
@Data
public class RabbitMqProducerProperty extends ProducerProperty {
    public static final String PREFIX = ProducerProperty.PREFIX+".rabbitmq";
    /**
     * The Address
     */
